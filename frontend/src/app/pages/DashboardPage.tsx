    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Button onClick={() => navigate('/create')} className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg shadow-blue-500/25">
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            ...
            <Button variant="ghost" onClick={() => navigate('/surveys')} className="text-blue-600 hover:text-blue-700">
              View All
            </Button>
          </div>
              ...
              <Card key={survey.id} className="p-6 border-0 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="ml-4 bg-gradient-to-r from-blue-50 to-purple-50 text-blue-600 hover:from-blue-100 hover:to-purple-100 border-0"
                  >
                    View Analytics
                  </Button>
                </div>
